...
var userMe = User(userName: "Willian", email: "opayoq@1234.com", age: 20)
User.currentUser = userMe
 ...
 */
var userYou = User(userName: "Tu", email: "Tu@Tatu.tututu", age: 70)
userYou.logIn(user: userYou)
print(User.currentUser)
